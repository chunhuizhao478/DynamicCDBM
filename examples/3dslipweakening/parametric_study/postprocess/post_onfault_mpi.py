...
COMMON_PATH = "/scratch1/10024/zhaochun/projects/DynamicCDBM_09062025/examples/3dslipweakening/parametric_study/alpha/"
CASES = [
    # {
    ...
    # },
    {
        "name": "dynamic_solve_alpha0_dsigma0_db_eps1em4_csv_main_fault",
        "data_dir": COMMON_PATH,
        "file_prefix": "dynamic_solve_alpha0_dsigma0_db_eps1em4_csv_main_fault_",
        "index": {"start": 2, "end": 1800, "step": 2, "pad": 4},
        "dt": 0.005,
        "output_dir": COMMON_PATH +"../postprocess/alpha0_dsigma0_db_eps1em4_on_fault/",
    },
    {
        "name": "dynamic_solve_alpha0_dsigma0_db_eps1em5_csv_main_fault",
        "data_dir": COMMON_PATH,
        "file_prefix": "dynamic_solve_alpha0_dsigma0_db_eps1em5_csv_main_fault_",
        "index": {"start": 2, "end": 1800, "step": 2, "pad": 4},
        "dt": 0.005,
