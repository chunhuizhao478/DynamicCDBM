...
[AuxKernels]
  ...
  [get_initial_strain_aux_00]
    type = MaterialRankTwoTensorAux
    i = 0
    j = 0
    property = eps_e
    variable = eps_e_aux_00
  []
  [get_initial_strain_aux_11]
    type = MaterialRankTwoTensorAux
    i = 1
    j = 1
    property = eps_e
    variable = eps_e_aux_11
  []
  [get_initial_strain_aux_22]
    type = MaterialRankTwoTensorAux
    i = 2
    j = 2
    property = eps_e
    variable = eps_e_aux_22
  []
  [get_initial_strain_aux_01]
    type = MaterialRankTwoTensorAux
    i = 0
    j = 1
    property = eps_e
    variable = eps_e_aux_01
  []
  [get_initial_strain_aux_02]
    type = MaterialRankTwoTensorAux
    i = 0
    j = 2
    property = eps_e
    variable = eps_e_aux_02
  []
  [get_initial_strain_aux_12]
    type = MaterialRankTwoTensorAux
    i = 1
    j = 2
    property = eps_e
    variable = eps_e_aux_12
  []
[]
...
[UserObjects]
  ...
  [./init_sol_components]
    ...
    mesh = '../static_code_files/static_solve_alpha0d15_dsigma13_out.e'
...
[VectorPostprocessors]
  ...
  [off_fault]
    ...
    functors = 'vel_slipweakening_x vel_slipweakening_y vel_slipweakening_z disp_slipweakening_x disp_slipweakening_y disp_slipweakening_z eps_e_aux_00 eps_e_aux_11 eps_e_aux_22 eps_e_aux_01 eps_e_aux_02 eps_e_aux_12'
    positions = 'pos'
    sort_by = x
    execute_on = TIMESTEP_END
    discontinuous = false
