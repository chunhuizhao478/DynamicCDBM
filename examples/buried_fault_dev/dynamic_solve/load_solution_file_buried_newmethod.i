[Mesh]
    ...
    file = '../static_solve/static_solve_newmethod_out.e'
[]
...
[AuxVariables]
    ...
    [initial_breakage_aux]
        order = CONSTANT
        family = MONOMIAL
        initial_from_file_var = initial_breakage
        initial_from_file_timestep = LATEST  
    []
...
[Materials]
    ...
    [density]
        ...
        prop_values = 2700
    []
    #this nonADdensity is used for the nonreflectingBC only
    [nonADdensity]
        type = GenericConstantMaterial
