...
#include "MooseMesh.h"
#include "FarmsNonReflectDashpotBC.h"

registerMooseObject("DynamicCDBMApp", FarmsNonReflectDashpotBC);

InputParameters
FarmsNonReflectDashpotBC::validParams()
{
  InputParameters params = IntegratedBC::validParams();
  params.addClassDescription("Applies Lysmer damper in the normal and "
                             "tangential directions to soil boundary.");
  params += FarmsNonReflectDashpotBC::commonParameters();
...
InputParameters
FarmsNonReflectDashpotBC::commonParameters()
{
...
FarmsNonReflectDashpotBC::FarmsNonReflectDashpotBC(const InputParameters & parameters)
...
Real
FarmsNonReflectDashpotBC::computeQpResidual()
{
...
Real
FarmsNonReflectDashpotBC::computeQpJacobian()
{
  return _test[_i][_qp] * _density *
...
Real
FarmsNonReflectDashpotBC::computeQpOffDiagJacobian(unsigned int jvar)
{
