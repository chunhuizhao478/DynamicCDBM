...
#include "ADComputeDamageStressStatic.h"

registerMooseObject("DynamicCDBMApp", ADComputeDamageStressStatic);

InputParameters
ADComputeDamageStressStatic::validParams()
{
...
void
ADComputeDamageStressStatic::initialSetup()
{
...
void
ADComputeDamageStressStatic::computeQpStress()
{
