...
#include "InitialDamageBenchmark.h"
 ...
 */
registerMooseObject("DynamicCDBMApp", InitialDamageBenchmark);

InputParameters
InitialDamageBenchmark::validParams()
{
...
InitialDamageBenchmark::InitialDamageBenchmark(const InputParameters & parameters)
  : Material(parameters),
...
void
InitialDamageBenchmark::initQpStatefulProperties()
{
}

void
InitialDamageBenchmark::computeQpProperties()
{
