...
#include "ADInitialDamageCycleSim3DPlane.h"
 ...
 */
registerMooseObject("DynamicCDBMApp", ADInitialDamageCycleSim3DPlane);

InputParameters
ADInitialDamageCycleSim3DPlane::validParams()
{
...
ADInitialDamageCycleSim3DPlane::ADInitialDamageCycleSim3DPlane(const InputParameters & parameters)
...
void
ADInitialDamageCycleSim3DPlane::initQpStatefulProperties()
{
}

void
ADInitialDamageCycleSim3DPlane::computeQpProperties()
{
