...
#include "InitialDamageCycleSim3DPlane.h"
 ...
 */
registerMooseObject("DynamicCDBMApp", InitialDamageCycleSim3DPlane);

InputParameters
InitialDamageCycleSim3DPlane::validParams()
{
...
void
InitialDamageCycleSim3DPlane::initQpStatefulProperties()
{
}

void
InitialDamageCycleSim3DPlane::computeQpProperties()
{
