...
#include "InitialBreakageBenchmark.h"

/**
 *  Created by Chunhui Zhao, Dec 4th, 2024
 *  Material used in defining initial breakage profile with exponential decay along the normal direction
 */
registerMooseObject("DynamicCDBMApp", InitialBreakageBenchmark);

InputParameters
InitialBreakageBenchmark::validParams()
{
...
InitialBreakageBenchmark::InitialBreakageBenchmark(const InputParameters & parameters)
  : Material(parameters),
  _initial_damage(declareProperty<Real>("initial_breakage")),
...
void
InitialBreakageBenchmark::initQpStatefulProperties()
{
}

void
InitialBreakageBenchmark::computeQpProperties()
{
