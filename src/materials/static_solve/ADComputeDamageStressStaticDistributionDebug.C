...
#include "ADComputeDamageStressStaticDistributionDebug.h"

registerMooseObject("DynamicCDBMApp", ADComputeDamageStressStaticDistributionDebug);

InputParameters
ADComputeDamageStressStaticDistributionDebug::validParams()
{
...
ADComputeDamageStressStaticDistributionDebug::ADComputeDamageStressStaticDistributionDebug(const InputParameters & parameters)
...
void
ADComputeDamageStressStaticDistributionDebug::initialSetup()
{
...
void
ADComputeDamageStressStaticDistributionDebug::computeQpStress()
{
...
ADReal
ADComputeDamageStressStaticDistributionDebug::computegammar()
{
...
std::vector<ADReal>
ADComputeDamageStressStaticDistributionDebug::computecoefficients(ADReal gamma_damaged_r)
{
...
ADReal 
ADComputeDamageStressStaticDistributionDebug::alphacr_root1(ADReal xi, ADReal gamma_damaged_r) {
