...
#include "InitialBreakageCycleSim3DPlane.h"
 ...
 */
registerMooseObject("DynamicCDBMApp", InitialBreakageCycleSim3DPlane);

InputParameters
InitialBreakageCycleSim3DPlane::validParams()
{
...
InitialBreakageCycleSim3DPlane::InitialBreakageCycleSim3DPlane(const InputParameters & parameters)
  : Material(parameters),
    _initial_breakage(declareProperty<Real>("initial_breakage")),
...
void
InitialBreakageCycleSim3DPlane::initQpStatefulProperties()
{
}

void
InitialBreakageCycleSim3DPlane::computeQpProperties()
{
