...
#include "SlipWeakeningFrictionczm3dCDBMOld.h"
#include "InterfaceKernel.h"

registerMooseObject("DynamicCDBMApp", SlipWeakeningFrictionczm3dCDBMOld);

InputParameters
SlipWeakeningFrictionczm3dCDBMOld::validParams()
{
...
SlipWeakeningFrictionczm3dCDBMOld::SlipWeakeningFrictionczm3dCDBMOld(const InputParameters & parameters)
...
void
SlipWeakeningFrictionczm3dCDBMOld::computeInterfaceTractionAndDerivatives()
{
