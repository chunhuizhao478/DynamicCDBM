...
[Mesh]
  [./msh]
    ...
    file = '../../examples/3dslipweakening/mesh/v3_400m_freesurface.msh'
  []
  [./new_block_1]
...
[UserObjects]
  ...
  [./init_sol_components]
    ...
    mesh = '../../examples/3dslipweakening/static_solve/static_solve_alpha0d3_dsigma0_out.e'
...
[VectorPostprocessors]
  ...
  [off_fault]
    ...
    functors = 'displacement_jump_strike_aux displacement_jump_rate_strike_aux traction_strike_aux
                alpha_damagedvar_aux B_aux xi_aux vel_slipweakening_x vel_slipweakening_y vel_slipweakening_z
                disp_slipweakening_x disp_slipweakening_y disp_slipweakening_z' 
    positions = 'functors_downselection'
    sort_by = x
    execute_on = 'TIMESTEP_END'
    discontinuous = true
  []
...
[Positions]
  ...
  [functors_downselection]
    ...
    input_positions = 'pos'
    expression = '(z > ${nucl_center_z} - ${fparse 1*elem_size}) & (z < ${nucl_center_z} + ${fparse 1*elem_size})'
    execute_on = 'TIMESTEP_END'
  []
[]