...
class SlipWeakeningFrictionczm3dCDBMOverstress : public CZMComputeLocalTractionTotalBase
{
public:
  static InputParameters validParams();
  SlipWeakeningFrictionczm3dCDBMOverstress(const InputParameters & parameters);
