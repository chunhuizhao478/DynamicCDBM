...
/**
 * ADComputeDamageStressStaticDistributionDebug computes the stress following linear elasticity theory (small strains)
 */
class ADComputeDamageStressStaticDistributionDebug : public ADComputeStressBase
{
public:
  static InputParameters validParams();

  ADComputeDamageStressStaticDistributionDebug(const InputParameters & parameters);
