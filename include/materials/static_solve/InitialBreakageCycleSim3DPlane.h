 ...
 */
class InitialBreakageCycleSim3DPlane : public ADMaterial
{
public:
  static InputParameters validParams();

  InitialBreakageCycleSim3DPlane(const InputParameters & parameters);
...
protected:
  ...
  /// Material property initial breakage profile
  MaterialProperty<Real> & _initial_breakage;
